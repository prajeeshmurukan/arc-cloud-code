 ...
 * @see com.arc.cloud.dao.hib2.hib.codegen.Customers
	...
	public Customers findById(int id) {
		...
		try {
			Customers instance = (Customers) sessionFactory.getCurrentSession()
					.get("com.arc.cloud.dao.hib2.hib.codegen.Customers", id);
			if (instance == null) {
	...
	public List findByExample(Customers instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.arc.cloud.dao.hib2.hib.codegen.Customers").add(Example.create(instance))
					.list();
