		...
		<div class="flex-grid no-responsive-future" style="height: 100%;">
			<div class="row" style="height: 100%">
				...
				<jsp:include page="_00_menu.jsp">
					<jsp:param name="active" value="bulkimport" />
				</jsp:include>


				<!-- Inclde menu JSP complete -->
				<div class="cell auto-size padding20 bg-white" id="cell-content">
<h1 class="text-light">Bulk - Import..</h1>
					...
					<div class="input-control">
						<button class="button fg-red" onclick="showDialog('#id-confirmation-upload');">Upload</button>
					</div>
	...
	<!--  -->
    <div data-role="dialog" id="id-confirmation-upload" data-overlay ="true" class="padding20" data-close-button="true" data-type="info" data-close-button="true" >
            <h3>Are you sure want to upload these files ?</h3>
        
			 <hr class="thin"/>
			 This Functionality requires uploading all required files to the server and import in to respective vaults. This will double the time , <br>normally reqired for a bulk upload via the thick client tool <br>
