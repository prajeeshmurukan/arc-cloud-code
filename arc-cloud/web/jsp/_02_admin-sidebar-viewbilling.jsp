...
<%@page import="com.arc.cloud.dao.hib2.hib.codegen.Document"%>
...
<script>
	...
	<%
		...
		List lst = UIDBUtil.getAddDocsforOrg(String.valueOf(orgId));
	%>
		...
		<div class="flex-grid no-responsive-future" style="height: 100%;">
			<div class="row" style="height: 100%">
				...
				<div class="cell auto-size padding20 bg-white" id="cell-content">
					<h1 class="text-light">Billing Details</h1>
								...
								<thead>
									...
									SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
										...
										if(lst != null && lst.size() >0){
											...
											while(itr.hasNext()){
												Document ib = (Document)itr.next();
												out.print("<tr>");
												out.print("<td>" + ib.getId() +"</td>");
												out.print("<td>" + ib.getDocname() +"</td>");
												out.print("<td>" + ib.getDoctitle() +"</td>");
												out.print("<td>" + ib.getTxProject() +"</td>");
												out.print("<td>" + dateFormat.parse(ib.getDoccreatedt()) +"</td>");
												out.print("</tr>");
