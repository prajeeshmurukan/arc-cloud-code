 ...
 * @see com.arc.cloud.dao.hib.codegen.Inbox
...
public class InboxHome {
	...
	public Inbox findById(int id) {
		...
		try {
			Inbox instance = (Inbox) sessionFactory.getCurrentSession().get("com.arc.cloud.dao.hib.codegen.Inbox", id);
			if (instance == null) {
	...
	public List findByExample(Inbox instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.arc.cloud.dao.hib.codegen.Inbox")
