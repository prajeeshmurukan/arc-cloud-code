 ...
 * @see com.arc.cloud.dao.hib.codegen.Project
...
public class ProjectHome {
	...
	public Project findById(int id) {
		...
		try {
			Project instance = (Project) sessionFactory.getCurrentSession().get("com.arc.cloud.dao.hib.codegen.Project",
					id);
			if (instance == null) {
	...
	public List findByExample(Project instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.arc.cloud.dao.hib.codegen.Project")
