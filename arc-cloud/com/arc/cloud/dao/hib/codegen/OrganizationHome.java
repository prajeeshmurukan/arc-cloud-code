 ...
 * @see com.arc.cloud.dao.hib.codegen.Organization
	...
	public Organization findById(long id) {
		...
		try {
			Organization instance = (Organization) sessionFactory.getCurrentSession()
					.get("com.arc.cloud.dao.hib.codegen.Organization", id);
			if (instance == null) {
	...
	public List findByExample(Organization instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.arc.cloud.dao.hib.codegen.Organization").add(Example.create(instance)).list();
