 ...
 * @see com.arc.cloud.dao.hib.codegen.Document
...
public class DocumentHome {
	...
	public Document findById(int id) {
		...
		try {
			Document instance = (Document) sessionFactory.getCurrentSession()
					.get("com.arc.cloud.dao.hib.codegen.Document", id);
			if (instance == null) {
	...
	public List findByExample(Document instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.arc.cloud.dao.hib.codegen.Document")
