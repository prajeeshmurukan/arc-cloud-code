 ...
 * @see com.arc.cloud.dao.hib.codegen.Customers
...
public class CustomersHome {
	...
	public Customers findById(int id) {
		...
		try {
			Customers instance = (Customers) sessionFactory.getCurrentSession()
					.get("com.arc.cloud.dao.hib.codegen.Customers", id);
			if (instance == null) {
	...
	public List findByExample(Customers instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.arc.cloud.dao.hib.codegen.Customers")
