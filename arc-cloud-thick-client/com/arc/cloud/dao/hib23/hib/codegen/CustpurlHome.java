 ...
 * @see com.arc.cloud.dao.hib23.hib.codegen.Custpurl
...
public class CustpurlHome {
	...
	public Custpurl merge(Custpurl detachedInstance) {
		...
		try {
			Custpurl result = (Custpurl) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Custpurl findById(int id) {
		...
		try {
			Custpurl instance = (Custpurl) sessionFactory.getCurrentSession()
					.get("com.arc.cloud.dao.hib23.hib.codegen.Custpurl", id);
			if (instance == null) {
	...
	public List<Custpurl> findByExample(Custpurl instance) {
		...
		try {
			List<Custpurl> results = (List<Custpurl>) sessionFactory.getCurrentSession()
					.createCriteria("com.arc.cloud.dao.hib23.hib.codegen.Custpurl").add(create(instance)).list();
