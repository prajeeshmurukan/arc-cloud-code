 ...
 * @see com.arc.cloud.dao.hib2.hib.codegen.Document
    ...
    public Document findById( int id) {
        ...
        try {
            Document instance = (Document) sessionFactory.getCurrentSession()
                    .get("com.arc.cloud.dao.hib2.hib.codegen.Document", id);
            if (instance==null) {
    ...
    public List<Document> findByExample(Document instance) {
        ...
        try {
            List<Document> results = (List<Document>) sessionFactory.getCurrentSession()
                    .createCriteria("com.arc.cloud.dao.hib2.hib.codegen.Document")
                    .add( create(instance) )
            .list();
