...
public class InboxHome {
    ...
    public Inbox merge(Inbox detachedInstance) {
        ...
        try {
            Inbox result = (Inbox) sessionFactory.getCurrentSession()
    ...
    public Inbox findById( int id) {
        ...
        try {
            Inbox instance = (Inbox) sessionFactory.getCurrentSession()
                    .get("com.arc.cloud.dao.hib2.hib.codegen.Inbox", id);
            if (instance==null) {
    ...
    public List<Inbox> findByExample(Inbox instance) {
        ...
        try {
            List<Inbox> results = (List<Inbox>) sessionFactory.getCurrentSession()
                    .createCriteria("com.arc.cloud.dao.hib2.hib.codegen.Inbox")
                    .add( create(instance) )
            .list();
